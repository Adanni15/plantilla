    ...
    <div class="content">
      <ul>
        ...
        if ($result_productos->num_rows > 0) {
            // Salida de datos de cada producto encontrado
            while($row = $result_productos->fetch_assoc()) {
                echo '<li><a href="detalle_producto.php?id=' . $row["id_producto"] . '"><img src="' . $row["img"] . '" width="140" height="250" alt="' . $row["nombre"] . '"></a>';
